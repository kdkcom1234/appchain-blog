...
export { Deposit, QueryDepositsResponse, QueryProposalsResponse, QueryVoteResponse, MsgVote, MsgDeposit, GenesisState, QueryProposalRequest, QueryProposalResponse, QueryVotesRequest, QueryParamsRequest, MsgSubmitProposalResponse, MsgVoteWeighted, MsgDepositResponse, Vote, QueryDepositRequest, QueryProposalsRequest, MsgVoteResponse, DepositParams, QueryVoteRequest, QueryVotesResponse, QueryTallyResultRequest, QueryTallyResultResponse, MsgSubmitProposal, TextProposal, TallyResult, VotingParams, QueryDepositsRequest, QueryParamsResponse, QueryDepositResponse, Proposal, MsgVoteWeightedResponse, WeightedVoteOption, TallyParams };
